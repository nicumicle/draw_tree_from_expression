...
require_once("SimpleObject.class.php");
...
class Expression
{
     ...
     * @param array $function_symbold_arr [optional] array $function_symbold_arr Array of accepted symbols and numbers
    ...
    function parser()
    {
        ...
        if (!in_array($c1, $this->symbols_arr)) {
            $this->id++;
            $this->tree_array[] = new SimpleObject($this->id, $c1, $this->parents_arr[$this->parent]);
        }
        if ($c1 == "(") {
            $this->parent_index++;
     ...
     * @return string First char of the string
     */
     ...
     * @return array|bool Array of error messages if there are errors or false if no error
     */
